...
class kerasGridSearchCV(GridSearchCV):
    ...
    def _fit2(self, X, y, groups, parameter_iterable, session):
        ...
        )(delayed(_fit_and_score_keras)(clone(base_estimator), X, y, self.scorer_,
    ...
    def fit2(self, X, y=None, groups=None, session = None):
        ...
        groups : array-like, with shape (n_samples,), optional
            ...
            train/test set.
        """
        return self._fit2(X, y, groups, ParameterGrid(self.param_grid),session)