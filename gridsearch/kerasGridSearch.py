...
def _fit_and_score_keras2(method, X, y, scorer, train, test, verbose,
                   parameters, fit_params, type ="Classification",return_train_score=False,
                   return_parameters=False, return_n_test_samples=False,
...
class kerasGridSearchCV2(GridSearchCV):
    ...
    def fit(self, X, y=None, groups=None, type="Classifier",**fit_params):
        ...
        **fit_params : dict of string -> object
        ...
        out = Parallel(
            n_jobs=self.n_jobs, verbose=self.verbose,
            pre_dispatch=pre_dispatch
        )(delayed(_fit_and_score_keras2)(base_estimator, X, y, scorers, train,
                                  test, self.verbose, parameters,
                                  fit_params=fit_params,
                                  return_train_score=self.return_train_score,
                                  return_n_test_samples=True,
